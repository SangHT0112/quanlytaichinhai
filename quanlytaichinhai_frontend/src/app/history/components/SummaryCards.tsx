...
export default function SummaryCards({ totalIncome, totalExpense }: SummaryCardsProps) {
  return (
    <div className="grid gap-4 md:grid-cols-3">
      <div className="bg-white dark:bg-white rounded-lg p-4 shadow border">
        <div className="flex items-center justify-between text-sm font-medium mb-2 text-gray-900">
