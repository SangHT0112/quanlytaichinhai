...
    **- QUAN TRỌNG: Nếu bất kỳ giá trị chuỗi nào (như "message" hoặc "group_name") có chứa dấu nháy kép ("), phải dùng ký tự thoát (\\") trước chúng để đảm bảo JSON hợp lệ (ví dụ: "tô hủ tiếu \\"đỉnh cao\\"").**
