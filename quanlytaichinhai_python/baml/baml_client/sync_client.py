...
class BamlSyncClient:
    ...
    def ExtractInvoices(self, images: typing.List[baml_py.Image],
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractInvoices", args={
                "images": images,
            })
...
class BamlStreamClient:
    ...
    def ExtractInvoices(self, images: typing.List[baml_py.Image],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.Invoices, types.Invoices]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractInvoices", args={
            "images": images,
        })
        return baml_py.BamlSyncStream[stream_types.Invoices, types.Invoices](
          result,
...
class BamlHttpRequestClient:
    ...
    def ExtractInvoices(self, images: typing.List[baml_py.Image],
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractInvoices", args={
            "images": images,
        }, mode="request")
        return result
